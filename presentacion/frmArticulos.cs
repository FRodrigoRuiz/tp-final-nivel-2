...
namespace presentacion
{
    public partial class frmArticulos : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DialogResult respuesta = MessageBox.Show("¿Está seguro que quiere eliminar este artículo?", "Eliminando", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private bool validarFiltro()
        {
            ...
            {
                MessageBox.Show("Por favor, seleccine el campo para filtrar.");
                return true;
            }
